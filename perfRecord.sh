...
gprof matrix_mul_single Results/gmon_matrix_mul.out >Results/gprof_single_$timestamp.txt

# using gprof to generate the profile for the matrix_multiply_parallel
gprof matrix_multiply_parallel Results/gmon_parallel_matrix_mul.out >Results/gprof_parallel_$timestamp.txt
